...
\section{Transconductance, Output Resistance, and Gain}
	...
	resulting in $g_m = 1.20 \times 10^{-5}\ \Omega^{-1}$
    \subsection{Discussion}
...
\section{Unity-Gain Follower Step Response}
   \begin{figure}[H]
    ...
    \end{figure}
	The response (output change) of the circuit is relatively symmetrical. Both the rising and falling edges have the same shape and roughly the same time constant. As shown in the graph, both sides look very similar (just inverted from each other).
