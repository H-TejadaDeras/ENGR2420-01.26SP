...
\section{Input/Gate Characteristics}
	...
	\begin{table}
		\begin{tabular}{c c c c}
			MOSFET & $I_s$ & $\kappa$ & $V_{T0}$\\
			1 & $1.6941 * 10^{-06}$ A & 0.7365 & 0.5905 V\\
			2 & $1.6771 * 10^{-06}$ A & 0.7377 & 0.5877 V\\
			3 & $1.6871 * 10^{-06}$ A & 0.7361 & 0.5900 V\\
			4 & $1.6953 * 10^{-06}$ A & 0.7366 & 0.5885 V\\
		\end{tabular}
	\end{table}
	\subsection{Analysis}
